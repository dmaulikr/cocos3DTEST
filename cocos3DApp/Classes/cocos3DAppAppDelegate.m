/**
 *  cocos3DAppAppDelegate.m
 *  cocos3DApp
 *
 *  Created by phraxos on 7/1/13.
 *  Copyright __MyCompanyName__ 2013. All rights reserved.
 */

#import "cocos3DAppAppDelegate.h"
#import "cocos3DAppLayer.h"
#import "cocos3DAppScene.h"
#import "CC3EAGLView.h"

#define kAnimationFrameRate		60		// Animation frame rate

@implementation cocos3DAppAppDelegate {
	UIWindow *window;
...
//	viewController.isOverlayingDeviceCamera = YES;
	...
	CC3Layer* cc3Layer = [cocos3DAppLayer node];
	[cc3Layer scheduleUpdate];
	
	// Create the customized 3D scene and attach it to the layer.
	// Could also just create this inside the customer layer.
	cc3Layer.cc3Scene = [cocos3DAppScene scene];
